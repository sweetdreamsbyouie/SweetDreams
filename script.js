...
function showLoadingVideo() {
    ...
    // Add planet rings (before pseudo-element)
    ...
    // Add planet rings (after pseudo-element)
...
async function submitOrderToGoogle(orderData, itemList, subtotalFormatted, total, selectedDate, loadingOverlay) {
    try {
        ...
        // Change overlay background to lighter and add the success content
